...
const ampoulesAtelierUrl = ampoulesAtelier.url;
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid md:grid-cols-12 gap-10 items-center pb-12 border-b border-[rgba(242,184,23,0.18)]">
          ...
          <div className="md:col-span-5 flex flex-col md:flex-row md:justify-end items-center gap-4 md:gap-5">
            <div className="text-center md:text-right leading-none">
              ...
              <div className="flex flex-col md:flex-row md:items-baseline gap-0.5 md:gap-1.5">
                <div className="font-serif text-[17px] sm:text-[19px] md:text-[21px] tracking-[0.12em] bg-gradient-to-r from-[#C9A96E] via-[#F2E1B8] to-[#C9A96E] bg-clip-text text-transparent drop-shadow-[0_1px_12px_rgba(201,169,110,0.45)]">
                  PADCON<span className="align-super text-[9px] ml-0.5 text-[#C9A96E]">®</span>
                  <span className="font-serif italic text-[15px] sm:text-[16px] md:text-[18px] tracking-[0.18em] text-[#C9A96E]/90 ml-1.5">
                    Platform
                  </span>
                </div>
                <div className="text-[10px] md:text-[11px] italic tracking-[0.18em] text-muted-foreground/60">
